    ...
    <Box sx={{ display: 'flex' }}>
      ...
      >
        ...
        <List dense>
          ...
          <ListItem disablePadding sx={{ display: 'block' }} onClick={() => navigate('/lister-exercice')}>
            <ListItemButton
              sx={{
          ...
          <ListItem disablePadding sx={{ display: 'block' }} onClick={() => navigate('/ajouter-modele')}>
            <ListItemButton
              sx={{
                border: '1px solid #d1d9e6',
                borderRadius: '6px',
