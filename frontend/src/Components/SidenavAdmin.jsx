  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      >
        <Toolbar />
        <List dense>
          <ListItem disablePadding sx={{ display: 'block' }} onClick={() => navigate('/dashboard-stud')}>
            <ListItemButton
              sx={{
          ...
          <ListItem disablePadding sx={{ display: 'block' }} onClick={() => navigate('/deposer-exercice')}>
            <ListItemButton
              sx={{
